...
const DialogItem = (props) => {
    ...
    return (
        <div>
            <NavLink to={path} className="messenger__element">
                <div className="messenger__element-content">
                    <img className="messenger__info-ava" src={props.imgId} width="60" height="60" />
                    <div className="messenger__element-inscription">
                        <a className="padding-for-name">{props.name}</a>
